...
curl -X POST -d "username=olga&password=223355aa" http://127.0.0.1:8000/api/auth/token/
$ curl -H "Authorization: JWT <your_token>" http://127.0.0.1:8000/api/auth/comments/
